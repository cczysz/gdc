setwd('/home/t.cri.cczysz/gdc/kirp')
...
kirp_deseq <- performDE(exprs, cond)
save(kirp_deseq, file='kirp_de.Robj')

kirp_results <- results(kirp_deseq, parallel=T)
kirp_results <- kirp_results[order(kirp_results$padj),]
save(kirp_results, file='kirp_results.Robj')
